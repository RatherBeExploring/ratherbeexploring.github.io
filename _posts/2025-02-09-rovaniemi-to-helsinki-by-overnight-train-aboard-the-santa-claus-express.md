...
<blockquote>Pay attention to which cabin you are assigned, and change it if you notice any red flags: three-bed cabin if you're solo or a couple, proximity to the doors, washrooms, or restaurant car.  The Finns are a respectful lot, so even if you don't get the ideal cabin, don't expect a rowdy ride.</blockquote>
